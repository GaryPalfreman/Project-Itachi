...
4. In **Advanced settings**, select Python 3.12 and add secrets for a model endpoint reachable from the cloud. The app cannot reach `127.0.0.1` on your Mac. Start with no secrets to test the interface and ZIP search.
